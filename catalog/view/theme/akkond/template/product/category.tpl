...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div itemscope itemtype="http://schema.org/Blog" id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row">
        ...
        <?php } ?>
        <?php if ($description) { ?>
        <div itemprop="description" class="col-sm-10"><?php echo $description; ?></div>
        <?php } ?>
      </div>
      <hr>
      <?php } ?>
          ...
          <div class="product-thumb">
            ...
            <div>
              <div class="caption">
				...
				<p><?php echo 'Вес: '.$product['weight'].' кг'.' Хранение: '.$product['upc'].' мес '; ?></p>
                ...
                <p class="price">
                  ...
                  <?php echo $product['price'].' в коробке: '.$product['ean'].' штук '; ?>
                  <?php } else { ?>
